...
define config.name = _("SBU Senior Project")
...
define build.name = "SBUSeniorProject"
...
define config.layers = [ 'master', 'effects', 'transient', 'screens', 'overlay' ]
...
define config.save_directory = "FinalsWeek-1531185335"
