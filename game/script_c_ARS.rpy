...
label ARS_sequences_1:
    ...
    show text "{color=#000000}{size=30}{b}Composition: 1 / 2{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_2:
    ...
    show text "{color=#000000}{size=30}{b}Composition: 2 / 2{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_3:
    ...
    show text "{color=#000000}{size=30}{b}Typography: 1 / 2{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_4:
    ...
    show text "{color=#000000}{size=30}{b}Typography: 2 / 2{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_5:
    ...
    show text "{color=#000000}{size=30}{b}Poster Design: 1 / 3{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_6:
    ...
    show text "{color=#000000}{size=30}{b}Poster Design: 2 / 3{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_7:
    ...
    show text "{color=#000000}{size=30}{b}Poster Design: 3 / 3{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_8:
    ...
    show text "{color=#000000}{size=30}{b}Video Editing: 1 / 3{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_9:
    ...
    show text "{color=#000000}{size=30}{b}Video Editing: 2 / 3{/b}{/size}{/color}" at skill_check
...
label ARS_sequences_10:
    ...
    show text "{color=#000000}{size=30}{b}Video Editing: 3 / 3{/b}{/size}{/color}" at skill_check
